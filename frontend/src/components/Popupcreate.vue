...
<v-row justify="center">
    <v-dialog id="keep" v-model="dialog" persistent max-width="500px">
        ...
        <template v-slot:activator="{ on }">
            <v-btn small fab color="#00C853" dark v-on="on">
        ...
        <v-card>
            ...
            <v-col class="12" xl="6" lg="12" md="12" sm="12" align="left">
                <v-card-text class="py-1">
                    ...
                    <v-col align="start" justify="left">
                        ...
                        <v-col cols="12" xl="12" lg="12" md="12" sm="12">
                            ...
                            <v-col cols="12" xl="12" lg="12" md="12" sm="12" xs="12">
                                ...
                                <v-select label="Genders" :items="genders" item-text="gender" dense v-model="gender" style="font-family: 'Vision','Noto Sans Lao','Phetsarath OT','Saysettha OT',Roboto, Tahoma, Geneva, Verdana, sans-serif;"></v-select>
                            </v-col>
            ...
            <v-card-actions>
                ...
                <v-btn color="#00C853" class="white--text" @click="save">
                    <v-icon> save</v-icon>
...
export default {
    ...
    methods: {
        ...
        //ບັນທຶກ
        async save() {
            let res = await this.axios.post("/api/register/create", {
